    ...
    try{
      ...
      cpuStat.usagePercent(function (e, percent, seconds) {
        ...
        const botinfo = new Discord.MessageEmbed()
            .setAuthor(client.user.tag + " Information", es.footericon && (es.footericon.includes("http://") || es.footericon.includes("https://")) ? es.footericon : client.user.displayAvatarURL(), `https://discord.com/oauth2/authorize?client_id=841186843575844885&permissions=4228906103&scope=bot`) 
            ...
            .addField(client.la[ls].cmds.info.botinfo.field4.title, `\`\`\`yml\nName: TNDEADSHOT#8167\nID: [772416455312146432]\`\`\``, true)
            .addField(client.la[ls].cmds.info.botinfo.field5.title, handlemsg(client.la[ls].cmds.info.botinfo.field5.value, {invitelink: `https://discord.com/oauth2/authorize?client_id=841186843575844885&permissions=4228906103&scope=bot`}))
